(function() {
    ...
    var n = function(a, b) { for (var c in b) b.hasOwnProperty(c) && (a[c] = b[c]) },
        p = function(a) {
            for (var b in a)
    ...
    var r = window,
        u = document,
        v = function(a, b) { u.addEventListener ? u.addEventListener(a, b, !1) : u.attachEvent && u.attachEvent("on" + a, b) };
    var w = /:[0-9]+$/,
        y = function(a, b) {
            b && (b = String(b).toLowerCase());
            if ("protocol" === b || "port" === b) a.protocol = x(a.protocol) || x(r.location.protocol);
            "port" === b ? a.port = String(Number(a.hostname ? a.port : r.location.port) || ("http" == a.protocol ? 80 : "https" == a.protocol ? 443 : "")) : "host" === b && (a.hostname = (a.hostname || r.location.hostname).replace(w, "").toLowerCase());
            var c = x(a.protocol);
            b && (b = String(b).toLowerCase());
            switch (b) {
                ...
                case "protocol":
                    ...
                    break;
                case "host":
                    a = a.hostname.replace(w, "").toLowerCase();
                    break;
                case "port":
        ...
        x = function(a) { return a ? a.replace(":", "").toLowerCase() : "" },
        z = function(a) {
    ...
    function A() { for (var a = B, b = {}, c = 0; c < a.length; ++c) b[a[c]] = c; return b }
    ...
    var K = /(.*?)\*(.*?)\*(.*)/,
        ...
        R = function(a) {
            return function(b) {
                var c = z(r.location.href),
                    d = c.search.replace("?", "");
                a: {
                    var e = d.split("&");
                    for (var f = 0; f < e.length; f++) { var g = e[f].split("="); if ("_gl" === decodeURIComponent(g[0]).replace(/\+/g, " ")) { e = g.slice(1).join("="); break a } }
                    e = void 0
                }
                b.query = P(e || "") || {};
                e = y(c, "fragment");
    ...
    var Q = function(a, b, c) {
            ...
            r.history && r.history.replaceState && (M.test(b) || M.test(c)) && (a = y(a, "path"), b = d(b, "?"), c = d(c, "#"), r.history.replaceState({}, void 0, "" + a + b + c))
        },
        P = function(a) {
            var b = void 0 === b ? 3 : b;
            try {
    ...
    function T(a, b, c) {
        ...
        e = e[3] || "";
        var g = "_gl=" + a;
        c ? e = "#" + d(e.substring(1)) : f = "?" + d(f.substring(1));
        return "" + b + f + e
    }

    function U(a, b, c) {
        for (var d = {}, e = {}, f = I().decorators, g = 0; g < f.length; ++g) {
            var h = f[g];
            (!c || h.forms) && H(h.domains, b) && (h.fragment ? n(e, h.callback()) : n(d, h.callback()))
        }
        p(d) && (b = O(d), c ? V(b, a) : W(b, a, !1));
        !c && p(e) && (c = O(e), W(c, a, !0))
    }

    function W(a, b, c) { b.href && (a = T(a, b.href, void 0 === c ? !1 : c), q.test(a) && (b.href = a)) }
    ...
    function V(a, b) {
        if (b && b.action) {
            ...
            } else "post" === c && (a = T(a, b.action), q.test(a) && (b.action = a))
        }
    }
    var X = function(a) {
            try {
                a: {
                    ...
                    for (a = 100; b && 0 < a;) {
                        if (b.href && b.nodeName.match(/^a(?:rea)?$/i)) { var c = b; break a }
                        b = b.parentNode;
                        a--
                    }
                    c = null
                }
                if (c) { var d = c.protocol; "http:" !== d && "https:" !== d || U(c, c.hostname, !1) }
            }
            catch (e) {}
        },
        Y = function(a) {
    ...
    l("google_tag_data.glBridge.auto", function(a, b, c, d) {
        var e = I();
        e.init || (v("mousedown", X), v("keyup", X), v("submit", Y), e.init = !0);
    ...
    l("google_tag_data.glBridge.decorate", function(a, b, c) {
        c = !!c;
        a = O(a);
        if (b.tagName) { if ("a" == b.tagName.toLowerCase()) return W(a, b, c); if ("form" == b.tagName.toLowerCase()) return V(a, b) }
        if ("string" == typeof b) return T(a, b, c)
    });
    l("google_tag_data.glBridge.generate", O);
...
(function() {
    ...
    var ha = window.GoogleAnalyticsObject,
        Qa;
    if (Qa = void 0 != ha) Qa = -1 < (ha.constructor + "").indexOf("String");
    var Za;
    if (Za = Qa) {
        var te = window.GoogleAnalyticsObject;
        Za = te ? te.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "") : ""
    }
    var gb = Za || "ga",
        jd = /^(?:utma\.)?\d+\.\d+$/,
        kd = /^amp-[\w.-]{22,64}$/,
    ...
    var ea = function(a) { return "function" == typeof a },
        ...
        za = function(a, b) {
            if (1 == b.length && null !=
                b[0] && "object" === typeof b[0]) return b[0];
    ...
    var F = window,
        ...
        G = function(a) {
            ...
            try { var c = F.external; if (c && c._gaUserPrefs && "oo" == c._gaUserPrefs) return !0 } catch (g) {}
            a = [];
    ...
    var oc, Id = /^.*Version\/?(\d+)[^\d].*$/i,
        ne = function() {
            ...
            if (void 0 === oc) {
                ...
                if (a) {
                    var b = a;
                    try { b = decodeURIComponent(a) } catch (c) {}
    ...
    var Fa, Ga, fb, Ab, ja = /^https?:\/\/[^/]*cdn\.ampproject\.org\//,
        ...
        da = function(a) {
            a: {
                if (ja.test(M.referrer)) {
                    ...
                    b: {
                        ...
                        if (!d) { if (0 == c.indexOf("xn--")) { c = ""; break b }(c = c.match(/(.*)\.cdn\.ampproject\.org\/?$/)) && 2 == c.length && (d = c[1].replace(/-/g, ".").replace(/\.\./g, "-")) }
                        c = d ? d.replace(Ue, "") : ""
                    }
                    if (b ==
            ...
            if (b && !1 !== a[Kd] && (void 0 === Ab && (b = (b = De.get()) && b._ga || void 0) && (Ab = b, J(81)), void 0 !== Ab)) return a[Q] || (a[Q] = Ab), !1;
            if (a[Kd]) {
                J(67);
                ...
                if (void 0 !== Ab) a[Q] || (a[Q] = Ab);
                    ...
                    elseif(b = Ca("AMP_TOKEN"), 0 == b.length) b = !0;
                    else {
    ...
    var oe = function() { return (Ba || "https:" == M.location.protocol ? "https:" : "http:") + "//www.google-analytics.com" },
        Da = function(a) {
            this.name = "len";
            this.message = a + "-8192"
        },
                ...
                if (4 == g.readyState) {
                    if (d) try {
                        ...
                        if (1 > ca.length) ge("xhr", "ver", "0"), c();
                            ...
                            var l = ca.charAt(1);
                            if ("d" == l) pe("https://stats.g.doubleclick.net/j/collect",
                                d.U, d, c);
                            else if ("g" == l) {
        ...
        ge = function(a, b, c) {
            1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j75",
                "sr=1"
            ], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc("https://www.google-analytics.com/u/d", a.join("&"), ua))
        };
    ...
    var Od = function() {
        ...
        Ed = function(a) {
            ...
            if (b.fa && b.$) return 0;
            b.$ = !0;
            if (a) { if (b.oa && void 0 !== a.get(b.oa)) return R(a, b.oa); if (0 == a.get(dc)) return 0 }
            if (0 == b.V) return 0;
            void 0 === c && (c = Bd());
    ...
    function $e(a) { var b = af(a); return { _ga: a.get(Q), _gid: a.get(I) || void 0, _gac: b ? [b.qa, b.timestamp].join(".") : void 0 } }
    ...
    var Jd = function(a, b, c) {
        ...
        Qd = function(a, b) { se(b) && zc(a.Y, "1", P(b, Yb), P(b, W), P(b, Na), 6E4) },
        se = function(a) { return !!a.get(ed) && !1 !== a.get(Ud) },
        re = function(a, b, c) {
            var d = new ee,
                e = function(ca) { $a(ca).F && d.set($a(ca).F, b.get(ca)) };
            e(hb);
            e(ib);
            e(Na);
            e(Q);
        ...
        H = function(a, b) { null === a.ra && (a.ra = 1 === Ed(b), a.ra && J(33)); return a.ra },
        Wd = /^gtm\d+$/;
    var fd = function(a, b) {
        a = a.b;
        if (!a.get("dcLoaded")) {
    ...
    var Sd = function(a) {
        if (!a.get("dcLoaded") && "cookie" == a.get(ac)) {
            ...
            if (se(a)) {
                var c = ne() !== H(b, a);
                a.set(Md, 1, !0);
                c ? (J(79), a.set(gd, oe() + "/j/collect", !0), a.set(qe, { U: re(b, a, 1), google: re(b, a, 2), count: 0 }, !0)) : a.set(gd, oe() + "/r/collect", !0)
            }
        }
    };
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
        pc = function(a) {
            function b(e, g) { d.b.data.set(e, g) }
            ...
            Jc(this.b, a[Q]);
            this.b.set(jb, Lc());
            bd(P(this.b, Na), P(this.b, W), P(this.b, Yb))
        },
        Jc = function(a, b) {
            var c = P(a, U);
    ...
    Z.v = function(a) {
        try {
            if (a.u) a.u.call(O, N.j("t0"));
                ...
                if (a.A) { if ("t0" == a.c && (b = N.create.apply(N, a.a), null === b)) return !0 } else if (a.ba) N.remove(a.c);
                else if (b)
